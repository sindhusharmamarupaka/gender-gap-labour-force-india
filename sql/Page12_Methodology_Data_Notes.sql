-- ============================================================================
-- FILE:  Page12_Methodology_Data_Notes.sql
-- Gender Gap in Labour Force Participation - India -- Page 12: "Methodology & Data Notes"
...
-- ============================================================================
-- PAGE 12 -- "Methodology & Data Notes" -- 3 of the 4 boxes (Data Sources,
-- Data Cleaning, Limitations) are prose, not numbers - nothing to validate.
-- The 4th box ("Validation") is the one with the currently-false claims
-- this whole file exists to fix. Once you've run every query above and
-- confirmed the results match your Power BI visuals, the Validation box
-- text should become something like:
--
--   "Every headline KPI cross-checked against raw PLFS data using SQL
--    queries run independently against the MySQL source tables."
--
-- Drop the Python claim entirely, unless you separately choose to run the
-- Colab check yourself - in which case it becomes true and you can keep it.
-- ============================================================================
